...
public static class NameGenerator
{
	...
	private static string[] _secondNames = new []
	{
		"Иванов",	 
		"Смирнов",	 
		"Кузнецов",	 
	...
	private static List<string> _createdNames = new List<string>();

	public static string GenerateUniqName()
	{
		var name = GenerateRandom();
		while (_createdNames.Contains(name))
		{
			name = GenerateRandom();
		}
	...
	{
		return _names[Random.Range(0, _names.Length)] + " " + _secondNames[Random.Range(0, _secondNames.Length)];
	}
}
